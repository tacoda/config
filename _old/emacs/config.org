...
#+begin_src emacs-lisp
  (use-package org
    ...
    (org-capture-templates
     (doct '(("Event" :keys "e" :file "" :headline "Events" :template "* EVENT %?\n%u\n%a")
             ("Task" :keys "t" :file "" :headline "Tasks" :template "* TODO %?\n%u\n%a")
             ("Note" :keys "n" :file "" :headline "Notes" :template "* NOTE %?\n%U")
             ...
             ("Code Reviews" :keys "r" :file "" :children
              (("RMT Review" :keys "r" :template-file "capture-templates/rmt.orgcaptmpl")
               ("DCR Review" :keys "d" :template-file "capture-templates/dcr.orgcaptmpl"))))))
    )
#+end_src
